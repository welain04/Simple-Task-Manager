...
export default function Home() {
  ...
  // Фильтрация и сортировка задач (Вариант 1: на стороне клиента)
  ...
  return (
    <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
      ...
      <div className="w-full max-w-2xl">
        ...
        {/* Фильтры (Добавлено в V2) */}
        {!isLoading && !fetchError && todos && todos.length > 0 && (
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 p-2 bg-muted/30 rounded-2xl border border-border/50"
          >
            ...
            >
              <TabsList className="w-full sm:w-auto grid grid-cols-3 sm:flex h-9 bg-transparent p-0">
                <TabsTrigger 
                  value="all" 
